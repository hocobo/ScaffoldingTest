...
public partial class Request
{
    ...
    public DateOnly? SubpoenaIssueDate { get; set; }

    public DateOnly? HearingDate { get; set; }

    public string? SubpoenaCaseNumber { get; set; }

    public string? Plaintiff { get; set; }

    public string? Defendant { get; set; }

    public bool? IsSubpoenaForPersonalAppearance { get; set; }

    public bool? IsSubpoenaForOriginalRecords { get; set; }
